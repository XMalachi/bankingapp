...
function Footer() {
  return (
    <footer className="bg-slate-900 p-4" aria-labelledby="footer-heading">
              ...
              <div className='my-10 lg:my-0'>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.company.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base text-gray-500 hover:text-gray-100">
                        {item.name}
                      </a>
                    </li>
                  ))}
          ...
          <div className="mt-12 xl:mt-0">
            <div className="leading-6">
                ...
                <div className='text-blue-50 my-2'>
                    <h3 className='text-md font-bold uppercase text-white'>Address</h3>
                    <p>
                      15 N Colonnade,
                ...
                <div className='text-blue-50 my-2'>
                    ...
                    <a href='/' target="_blank" rel='noreferrer' className='no-underline text-blue-300 hover:text-blue-600'>
        ...
        <div className="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
            ...
            <p className="mt-2 text-base text-gray-500">
              The latest financial news, articles, and resources, sent to your inbox weekly.
            </p>
          </div>
