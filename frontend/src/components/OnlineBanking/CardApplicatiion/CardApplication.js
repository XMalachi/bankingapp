...
const steps = [
  ...
  { id: '02', name: 'Select Card Type', description: 'Card Ttype Required', status: '' },
  { id: '02', name: 'Completed', description: 'Submit Card Application', status: '' },
]
...
function CardApplication() {
    ...
    const [cardType, showcardType] = useState(false)
  ...
  return (
    ...
    <h2 className='text-3xl'>Card Application</h2>
      ...
      <div>
        <CardForm form={form} cardType={cardType} completed={completed} checkConfirm={checkConfirm} chooseCardType={chooseCardType} confirmCard={confirmCard}  />
      </div>
    </div>
  )
}
